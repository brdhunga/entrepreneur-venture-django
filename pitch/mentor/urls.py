...
urlpatterns = patterns('',
    ...
    url(r'^applications/$', Mentor_List_Applications.as_view(), name = 'mentor_list_applications'),
    url(r'^applicants/$', Mentor_List_Applicants.as_view(), name = 'mentor_list_applicants'),
